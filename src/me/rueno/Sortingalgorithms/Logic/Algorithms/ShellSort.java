...
public class ShellSort extends DefaultVisualizedSortingAlgorithm{
	...
	public String getAlgorithmInfoText(){
		return "<html>"
				+ "<h2 style=\"text-align:center;font-family:sans-serif;\">Shellsort</h2>"
				+ "<p style=\"text-align:justify;font-family:sans-serif;\">Shellsort bedient sich prinzipiell des Insertionsorts. Es versucht den Nachteil auszugleichen, dass hier Elemente in der Sequenz"
